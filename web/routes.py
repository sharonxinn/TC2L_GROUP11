...
>>>>>>> 347aae512d12b7cb266239572d29c577195aef29
from . import db
...
def find_rides():
    profile = Profile.query.filter_by(user_id=current_user.id).first()
<<<<<<< HEAD
    driver_posts = Rides.query.filter_by(status='IN PROGRESS')
=======
...
>>>>>>> 347aae512d12b7cb266239572d29c577195aef29
    ...
    pickup_lat = 0
    pickup_lng = 0
    return render_template('findarides.html', drivers_data=drivers_data, pickup_lat=pickup_lat, pickup_lng=pickup_lng,profile=profile)
